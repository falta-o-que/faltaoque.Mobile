...
export default function CartRemoveIcon({ size = 24, color = '#494949' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path d="M11.5 12.5L14.5 9.5M14.5 12.5L11.5 9.5" stroke={color} strokeWidth={1.5} strokeLinecap="round" />
